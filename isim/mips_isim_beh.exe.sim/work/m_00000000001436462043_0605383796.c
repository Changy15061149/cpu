...
#endif
static const char *ng0 = "C:/Windows/System32/P7/BEextend.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
static int ng3[] = {2, 0};
...
LAB16:    t190 = (t0 + 2524);
    ...
    *((unsigned int *)t200) = (t202 | t196);
    xsi_driver_vfirst_trans(t190, 0, 3);
    t203 = (t0 + 2372);
    *((int *)t203) = 1;
...
LAB60:    if (*((unsigned int *)t82) > 0)
        goto LAB61;

LAB62:    memcpy(t81, t117, 8);

LAB63:    goto LAB24;

LAB25:    xsi_vlog_unsigned_bit_combine(t21, 4, t35, 4, t81, 4);
    goto LAB29;
...
LAB42:    xsi_vlog_unsigned_bit_combine(t35, 4, t71, 4, t76, 4);
    goto LAB46;
...
LAB59:    xsi_vlog_unsigned_bit_combine(t81, 4, t112, 4, t117, 4);
    goto LAB63;

LAB61:    memcpy(t81, t112, 8);
    goto LAB63;
...
LAB92:    if (*((unsigned int *)t180) > 0)
        goto LAB93;

LAB94:    if (*((unsigned int *)t154) > 0)
        goto LAB95;

LAB96:    memcpy(t153, t189, 8);

LAB97:    goto LAB75;

LAB76:    xsi_vlog_unsigned_bit_combine(t117, 4, t148, 4, t153, 4);
    goto LAB80;
...
LAB89:    t184 = ((char*)((ng10)));
    goto LAB90;

LAB91:    t189 = ((char*)((ng11)));
    goto LAB92;

LAB93:    xsi_vlog_unsigned_bit_combine(t153, 4, t184, 4, t189, 4);
    goto LAB97;
...
extern void work_m_00000000001436462043_0605383796_init()
{
	static char *pe[] = {(void *)Cont_28_0,(void *)Cont_29_1,(void *)Cont_30_2,(void *)Cont_32_3};
	xsi_register_didat("work_m_00000000001436462043_0605383796", "isim/mips_isim_beh.exe.sim/work/m_00000000001436462043_0605383796.didat");
