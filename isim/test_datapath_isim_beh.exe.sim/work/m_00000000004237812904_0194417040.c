...
#endif
static const char *ng0 = "C:/Windows/System32/P7/dataextend.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
static int ng3[] = {2, 0};
...
LAB29:    t70 = (t0 + 968U);
    t71 = *((char **)t70);
    t70 = ((char*)((ng4)));
    xsi_vlogtype_concat(t69, 32, 32, 2U, t70, 24, t71, 8);
    goto LAB30;
...
LAB53:    memcpy(t76, t125, 8);

LAB54:    goto LAB32;

LAB33:    xsi_vlog_unsigned_bit_combine(t39, 32, t69, 32, t76, 32);
    goto LAB37;
...
LAB46:    t108 = (t0 + 968U);
    ...
    *((unsigned int *)t111) = t120;
    xsi_vlog_mul_concat(t110, 24, 1, t108, 1U, t113, 1);
    xsi_vlogtype_concat(t107, 32, 32, 2U, t110, 24, t109, 8);
    goto LAB47;
...
LAB70:    memcpy(t125, t163, 8);

LAB71:    goto LAB49;

LAB50:    xsi_vlog_unsigned_bit_combine(t76, 32, t107, 32, t125, 32);
    goto LAB54;
...
LAB63:    t157 = (t0 + 1060U);
    t158 = *((char **)t157);
    t157 = ((char*)((ng4)));
    xsi_vlogtype_concat(t156, 32, 32, 2U, t157, 16, t158, 16);
    goto LAB64;
...
LAB83:    if (*((unsigned int *)t190) > 0)
        goto LAB84;

LAB85:    if (*((unsigned int *)t164) > 0)
        goto LAB86;

LAB87:    memcpy(t163, t212, 8);

LAB88:    goto LAB66;

LAB67:    xsi_vlog_unsigned_bit_combine(t125, 32, t156, 32, t163, 32);
    goto LAB71;
...
LAB80:    t195 = (t0 + 1060U);
    ...
    *((unsigned int *)t198) = t207;
    xsi_vlog_mul_concat(t197, 16, 1, t195, 1U, t200, 1);
    xsi_vlogtype_concat(t194, 32, 32, 2U, t197, 16, t196, 16);
    goto LAB81;

LAB82:    t213 = ((char*)((ng2)));
    memset(t212, 0, 8);
    xsi_vlog_unsigned_unary_minus(t212, 32, t213, 32);
    goto LAB83;

LAB84:    xsi_vlog_unsigned_bit_combine(t163, 32, t194, 32, t212, 32);
    goto LAB88;

LAB86:    memcpy(t163, t194, 8);
    goto LAB88;

}


extern void work_m_00000000004237812904_0194417040_init()
{
	static char *pe[] = {(void *)Cont_29_0,(void *)Cont_30_1,(void *)Cont_32_2};
	xsi_register_didat("work_m_00000000004237812904_0194417040", "isim/test_datapath_isim_beh.exe.sim/work/m_00000000004237812904_0194417040.didat");
